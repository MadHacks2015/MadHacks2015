...
module.exports = {
	...
	updateApplication:function(req, user, callback){
		...
		query += ' SET '
            ...
            + ',plan_known_partners="' + user.plan_known_partners + '"'
			+ ',resume="' + user.resume + '"'
